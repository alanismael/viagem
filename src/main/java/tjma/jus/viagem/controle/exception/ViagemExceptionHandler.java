package tjma.jus.viagem.controle.exception;
...
@ControllerAdvice
public class ViagemExceptionHandler extends ResponseEntityExceptionHandler {
    private final MessageSource messageSource;

    @Autowired
    public ViagemExceptionHandler(MessageSource messageSource) {
